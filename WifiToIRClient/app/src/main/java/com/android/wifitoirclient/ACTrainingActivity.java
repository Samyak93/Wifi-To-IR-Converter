...
public class ACTrainingActivity extends AppCompatActivity {
                ...
                try {
                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            IRDataDBHelper irDBHelper = new IRDataDBHelper(ACTrainingActivity.this);
                            IRDataBean iRDataBean = new IRDataBean();
                            iRDataBean.setName("on");
                            iRDataBean.setType("AC");
                            ...
                            Toast.makeText(ACTrainingActivity.this, "On Button Trained", Toast.LENGTH_LONG).show();
                        }
                ...
                try {
                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            Toast.makeText(ACTrainingActivity.this, "Program Plus Button Trained", Toast.LENGTH_LONG).show();
                        }
                ...
                try {
                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            Toast.makeText(ACTrainingActivity.this, "Program Minus Button Trained", Toast.LENGTH_LONG).show();
                        }
                ...
                try {
                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            Toast.makeText(ACTrainingActivity.this, "Volume Plus Button Trained", Toast.LENGTH_LONG).show();
                        }
                ...
                try {
                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            Toast.makeText(ACTrainingActivity.this, "Volume Minus Button Trained", Toast.LENGTH_LONG).show();
                        }
